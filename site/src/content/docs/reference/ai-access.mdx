...
description: Every machine readable output this documentation publishes, and what each one is for.
sidebar:
  order: 13
provenance:
  pageId: reference/ai-access
  area: reference
  ...
  networks: [none]
  verified: '2026-08-31'
  tags: [agents, llms, machine-readable]
---
...
<EntryCards
  cards={[
    { title: "Documentation MCP server", body: "Query pages, contracts, and vectors locally, with no network access and no credentials.", href: "/reference/mcp/" },
    { title: "Contracts", body: "OpenAPI documents, JSON Schemas, and the source manifest.", href: "/reference/openapi/" },
  ]}
/>
