...
description: How to add an executed case that the prose, the tools, and the tests all share.
sidebar:
  order: 4
provenance:
  pageId: contribute/conformance-vectors
  area: contribute
  audience: [developer]
...
5. Reference the case from the relevant page with `<VectorTable only={["your-case-id"]} />`.
