...
description: Four short routes through this documentation, one for each thing people actually come here to do.
sidebar:
  order: 3
provenance:
  pageId: start/choose-your-path
  area: start
  audience: [everyone]
...
<Aside type="note" title="Private operational material lives elsewhere">
...
<EntryCards
  label="Machine readable entry points"
  cards={[
    { kicker: 'Agents', title: 'AI and agent access', body: 'llms.txt, raw Markdown, page manifest, and the read-only MCP server.', href: '../../reference/ai-access/' },
    { kicker: 'Evidence', title: 'Conformance vectors', body: 'The deterministic cases that back the prose and the tools.', href: '../../reference/conformance/' },
    { kicker: 'Directory', title: 'Ecosystem registry', body: 'Wallets, indexers, explorers, and marketplaces with last-verified dates.', href: '../../ecosystem/' },
  ]}
/>
