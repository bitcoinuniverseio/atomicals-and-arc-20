# List an NFT, Realm, or Subrealm

The same lifecycle as an ARC-20 lot, plus the extra name check the Realm lanes carry.

Page ID: guides/list-an-nft-or-realm
Applicability: universe-implementation
Authority: universe-implementation
Networks: mainnet
Verified: 2026-08-31
Locale: en
URL: https://bitcoinuniverseio.github.io/atomicals-and-arc-20/guides/list-an-nft-or-realm/
